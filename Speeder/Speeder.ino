...
#define WHEEL_A      SIMPLE_SOUND_3
#define WHEEL_B      SIMPLE_SOUND_1
#define WHEEL_I      SIMPLE_SOUND_3
#define WHEEL_II     SIMPLE_SOUND_1
#define WHEEL_START  GOOD_GUYS
#define WHEEL_SELECT BAD_GUYS
#define WHEEL_L2     SIMPLE_SOUND_2
#define WHEEL_R2     SIMPLE_SOUND_2
#define WHEEL_LF_PU  LASER_CANNON
#define WHEEL_RT_PU  SIMPLE_SOUND_6
#define WHEEL_LF_PD  NOT_ASSIGNED
#define WHEEL_RT_PD  NOT_ASSIGNED
#define WHEEL_CTR_FW SIMPLE_SOUND_7
